...
# load
llama_tokenizer = AutoTokenizer.from_pretrained(llama_tokenizer_dir)
...
tokenizer = AutoTokenizer(vocab_file=output_sp_dir+'/japanese_llama.model')
...
# Test
llama_tokenizer = AutoTokenizer.from_pretrained(llama_tokenizer_dir)
japanese_llama_tokenizer = AutoTokenizer.from_pretrained(output_hf_dir)
